...
class TransformerEncoderLayerBase(nn.Module):
    ...
    *cfg.encoder.normalize_before* to ``True``.
    ...
    def forward(
        ...
        #   print('encoder: ',layer_norm_dropout_rate)
        """
        Args:
        ...
        """
        #if not self.training:
        #   print('encoder layer_norm_dropout_rate: ',layer_norm_dropout_rate)
        ...
        #print('encoder layer_norm_dropout_rate: ',layer_norm_dropout_rate)
        #print('layer_norm_dropout_rate: ',layer_norm_dropout_rate)
...
class TransformerDecoderLayerBase(nn.Module):
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def forward(
        ...
        # rd = random.uniform(0,1)
        #if not self.training:
        #   print('decoder layer_norm_dropout: ',layer_norm_dropout_rate)
