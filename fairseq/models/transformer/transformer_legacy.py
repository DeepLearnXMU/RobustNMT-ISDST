...
from fairseq.models.transformer.transformer_robust_all import (
    TransformerModelRobustAll,
)
...
class TransformerModel(TransformerModelBase):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--layer-norm-dropout',default=-1,type=float)
        parser.add_argument('--scheduled-layer-norm-dropout',default=None,type=str)
        parser.add_argument('--interval',default=1,type=int)
        parser.add_argument('--warmup-layer-norm-step',default=50000, type=int)
    @classmethod
...
@register_model("transformer_robust_all")
class TransformerModel(TransformerModelRobustAll):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--noise-type',type=str,choices=['replace','swap','remove','insert','hybrid'],default='replace')
        parser.add_argument('--noise-rate',type=float,default=0.0)
        parser.add_argument('--noise-seed',type=int,default=64)

        parser.add_argument('--is-half-batch',action='store_true',default=False)
        parser.add_argument('--symmetry',action='store_true',default=False)
        parser.add_argument('--apply-prob',type=float,default=1.0)
        parser.add_argument('--noise-update-freq',type=int,default=1)

        parser.add_argument('--curriculum-learning',action='store_true',default=False)
        parser.add_argument('--curriculum-args',type=str,default=None)
...
@register_model_architecture("transformer_robust_all", "transformer_robust_all")
def robust_base_architecture(args):
...
@register_model_architecture("transformer_robust_all", "transformer_iwslt_de_en_robust_all")
...
@register_model_architecture("transformer_robust_all", "transformer_wmt_en_de_robust_all")
def transformer_wmt_en_de_robust_all(args):
    robust_base_architecture(args)
